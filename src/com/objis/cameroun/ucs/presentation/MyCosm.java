...
public class MyCosm extends JFrame{
...
/*construction de l'interface graphique*/
	public MyCosm() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage("C:\\Users\\israel\\Desktop\\coconut-icon.png"));
		
		
		this.setSize(new Dimension(678, 374));//on a dimensionner la fenetre graphique
...
/* methode de construction de la barre de menu*/
	...
	private JMenuBar createMenuBar() {
		...
		mnuFile.addSeparator();
		 ...
		 JMenuItem mnuOpenFile = new JMenuItem( "Open Glossaire ..." );
	...
	public static void main(String[] args) throws Exception{
		...
		//afficher ma fenetre
		MyCosm mycosm = new MyCosm();//instancier la fenetre
